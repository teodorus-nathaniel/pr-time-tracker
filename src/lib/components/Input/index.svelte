...
<input
  ...
  } relative border border-solid border-l4 bg-l1 shadow-input rounded-xl p-2.25 text-footnote text-t1 transition-all placeholder:text-footnote placeholder:opacity-100 placeholder:text-t3 hover:border-accent1-default focus:border-accent1-default autofill:fill-t1 autofill:hover:text-t3 dark:bg-l2 disabled:cursor-not-allowed disabled:hover:border-l4 disabled:shadow-none`}
